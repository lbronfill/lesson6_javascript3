...
// declare variable for document element with id of leftarrow, whch is in the the html document
var leftarrow = document.getElementById ("leftarrow");

//add and event handlerto the specified document element ( leftarrow)
//the leftArrow() function will be executed when the user clicks the left navigation arro button
